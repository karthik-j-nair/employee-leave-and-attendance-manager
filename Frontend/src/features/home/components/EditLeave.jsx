...
const EditLeave = ({ onClose, reason, leaveId, startDate, endDate, leaveType }) => {
  const { handleEditLeave } = useHome();
...
}, [leaveType, startDate, endDate, reason, leaveId]);
  ...
  const handleSubmit = async (e) => {
    ...
    await handleEditLeave(formData);
    onClose();
